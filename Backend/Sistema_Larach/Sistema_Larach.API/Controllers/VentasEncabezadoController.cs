...
namespace Sistema_Larach.API.Controllers
{
    public class VentasEncabezadoController : Controller
    {
        ...
        public IActionResult ListGeneral()
        {
            try
            {
                var usuarios = _supermercadoService.Lisrtadoencabezado();
                return Ok(usuarios);
            }
            catch (Exception ex)
            {
                ...
                else
                {
                    ...
                    if (resultadoInsertarEncabezado != null && resultadoInsertarEncabezado.Venen_Id > 0)
                    {
                        var salidaEncabezado = new
                        {
                            ...
                            ClienteIdNuevo = resultadoInsertarEncabezado.ClienteIdNuevo,
                            EmpleadoIdNuevo = resultadoInsertarEncabezado.EmpleadoIdNuevo
                        };
